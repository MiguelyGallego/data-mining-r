...
```{r}
# Obtener las filas con valores NA en Square.Meters
na_rows <- is.na(df_madrid$Square.Meters)
na_rows
# Crear un dataframe con las variables predictoras de las filas NA
predictors <- df_madrid[na_rows, -c(Square.Meters)]

# Realizar la predicción de los metros cuadrados para las filas NA
predicted_square_meters <- predict(model, newdata = predictors)

# Rellenar los valores NA con los valores estimados
df_madrid$Square.Meters[na_rows] <- predicted_square_meters
```
